      ...
      <view v-for="record in records" :key="record.id" class="record-card">
        ...
        <view class="record-center">
          ...
          <view v-else class="record-times">
            ...
            <view
              class="record-time-item"
              v-if="record.clockIn && record.clockOut"
            >
              <text class="rt-label">工时</text>
              <text class="rt-value hl"
                >{{ formatHours(record.clockIn, record.clockOut) }}h</text
              >
            </view>
          </view>
        </view>
      ...
      <view class="modal-box" @tap.stop>
        ...
        <view class="form-row">
          ...
          <picker
            ...
            @change="onEditClockOut"
          >
            <view class="form-picker">
              <text class="form-picker-text">{{
                editForm.clockOut || "请选择"
              }}</text>
            </view>
          </picker>
        </view>
...
function loadRecords() {
  records.value = getRecordsByMonth(currentYear.value, currentMonth.value).sort(
